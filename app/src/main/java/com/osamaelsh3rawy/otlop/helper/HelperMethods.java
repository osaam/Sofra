...
public class  HelperMethods {
    ...
    //photo for fragment
    public static void initImage2(ImageView imageView,Activity activity) {
        ...
        Album.image(activity) // Image selection.
                ...
                .onResult(new Action<ArrayList<AlbumFile>>() {
                    ...
                    public void onAction(@NonNull ArrayList<AlbumFile> result) {
                        ...
                        HelperMethods.onLoadImageFromUrl(imageView, path, activity);
                    }
                })
    ...
    //photo for dialog
    public static void initImage3(ImageView imageView,Context activity) {
        Album.initialize(AlbumConfig.newBuilder(activity)
                .setAlbumLoader(new MediaLoader())
                .build());
        Album.image(activity) // Image selection.
