...
public class Restaurant {
    ...
    @Expose
    private ListOfAreaData region;
    @SerializedName("categories")
    @Expose
    private List<ListOfAreaData> categories = null;
    ...
    public ListOfAreaData getRegion() {
        return region;
    }

    public void setRegion(ListOfAreaData region) {
        this.region = region;
    }

    public List<ListOfAreaData> getCategories() {
        return categories;
    }

    public void setCategories(List<ListOfAreaData> categories) {
